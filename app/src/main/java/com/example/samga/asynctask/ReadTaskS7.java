...
public class ReadTaskS7 {
    ...
    public void downloadOnPreExecute(int t){
        Toast.makeText(vi_main_ui.getContext(), "Le traitementde la tâche de fond est démarré !", Toast.LENGTH_SHORT).show();
    ...
    private void downloadOnPostExecute(){
        Toast.makeText(vi_main_ui.getContext(), "e traitement de la tâche de fond est terminé", Toast.LENGTH_LONG).show();
